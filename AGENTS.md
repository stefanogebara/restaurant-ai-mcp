...
| **AI Services** | Anthropic Codex, OpenAI, ElevenLabs/Cartesia (TTS) |
...
- [x] manager-agent.js — Codex Codex-sonnet-4-6 core handler with memory + snapshot
...
- [x] manager-documents endpoint — PDF/text upload with Codex-haiku fact extraction
