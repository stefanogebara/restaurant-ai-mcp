...
function normalizeReservationCreateInput(input = {}, options = {}) {
...
function getMissingReservationCreateFields(input = {}, options = {}) {
...
function normalizeReservationModifyInput(input = {}) {
  const normalized = {
...
function mapReservationSummary(record = {}, extras = {}) {
  return {
