  ...
  return (
    <div className="border border-[#E5E7EB] rounded-lg overflow-hidden">
      <div className="p-5 border-b border-border-gray flex items-center gap-3">
        ...
        <div>
          <h2 className="text-sm font-semibold text-deep-charcoal">{t('insights.tonightBriefing')}</h2>
          <p className="text-xs text-warm-stone">{t('insights.reservationsForToday')}</p>
        </div>
      </div>
      ...
      <div className="p-5">
        ...
        <div className="flex items-center gap-4 mb-4">
          <div className="text-center">
            ...
            <div className="text-xs text-warm-stone">{t('insights.tonight')}</div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="text-xs text-warm-stone">{t('insights.highRisk')}</div>
          </div>
          {summary && (
            <>
              <div className="w-px h-8 bg-border-gray" />
              <div className="text-center">
                ...
                <div className="text-xs text-warm-stone">{t('insights.mediumRisk')}</div>
              </div>
            </>
          )}
        </div>
