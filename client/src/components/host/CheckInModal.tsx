...
export default function CheckInModal({ isOpen, reservation, onClose, onSuccess, availableTables }: CheckInModalProps) {
  ...
  return (
    ...
    >
      <div role="dialog" aria-modal="true" aria-label={t('dashboard.checkInReservation')} className="glass-modal p-6 max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
          ...
          <>
            ...
            <div className="flex gap-3 pt-4">
              ...
              <button
                ...
                className="flex-1 px-4 py-3 bg-rose-600 text-white font-medium rounded-xl hover:bg-rose-700 disabled:bg-muted-stone disabled:cursor-not-allowed transition-colors"
