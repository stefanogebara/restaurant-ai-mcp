...
export default function SeatPartyModal({ isOpen, data, onClose, onRetryTableSelection }: SeatPartyModalProps) {
  ...
  return (
    ...
    >
      <div role="dialog" aria-modal="true" aria-label="Confirm Seating" className="glass-modal p-6 max-w-md w-full mx-4">
        ...
        {seatPartyMutation.isSuccess ? (
          ...
          <>
            ...
            <div className="flex gap-3">
              <button
                onClick={onClose}
                className="flex-1 px-4 py-3 border border-glass-border-input text-stone-gray rounded-xl hover:bg-soft-gray font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-burgundy disabled:opacity-50"
              ...
              <button
                ...
                className="flex-1 px-4 py-3 bg-rose-600 text-white rounded-xl hover:bg-rose-700 font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-rose-600 disabled:bg-muted-stone disabled:cursor-not-allowed"
                disabled={seatPartyMutation.isPending}
              >
