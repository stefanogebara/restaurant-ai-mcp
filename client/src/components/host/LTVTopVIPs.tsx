        ...
        {topVIPs.map((customer, index) => (
          <div key={customer.customer_id} className="flex items-center justify-between p-2 bg-white/50 rounded-xl">
            <div className="flex items-center gap-3">
              <div className="w-6 h-6 rounded-full bg-ocre-600/20 flex items-center justify-center">
                <span className="text-xs font-bold text-ocre-600">#{index + 1}</span>
              </div>
              <div>
            ...
            <div className="text-right">
              <div className="text-sm font-bold text-ocre-600">{formatCurrency(customer.lifetime_value)}</div>
