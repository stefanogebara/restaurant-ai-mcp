  ...
  return (
    <div className="space-y-6">
          ...
          {(['7', '30'] as const).map(p => (
            <button
              ...
              className={`px-3 py-1.5 rounded-md text-[12px] font-medium transition-colors ${
                period === p
                  ? 'bg-white/70 backdrop-blur-glass-chip text-deep-charcoal border border-glass-border-dark'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] gap-6">
        ...
        <div className="space-y-6">
          {/* Bar chart */}
          <div className="glass-card border-glass-border-dark rounded-lg p-5">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
            {[
              ...
              <div key={label} className="glass-card border-glass-border-dark rounded-lg p-4">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="glass-card border-glass-border-dark rounded-lg p-4">
