    ...
    <div className="bg-white border border-border-gray rounded-2xl overflow-hidden">
      ...
      {entries.length === 0 ? (
        <div className="text-center py-10 px-6">
          ...
          <p className="text-sm font-semibold text-deep-charcoal mb-1">Ninguem esperando</p>
          <p className="text-xs text-stone-gray">Clientes adicionados a lista de espera aparecerao aqui</p>
        </div>
      ) : (
            ...
            return (
              ...
              >
                ...
                <div className="text-right flex-shrink-0 mr-2">
                  ...
                  <div className="text-[10px] text-muted-stone">espera</div>
                </div>
