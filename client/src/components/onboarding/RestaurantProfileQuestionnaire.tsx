...
export default function RestaurantProfileQuestionnaire({
  ...
  const renderStep1 = () => (
    ...
    >
      <div>
        <h2 className="text-2xl font-bold text-[#1C1917] mb-2">What type of restaurant do you run?</h2>
        <p className="text-[#57534E] text-sm">This helps us customize your dashboard experience</p>
      </div>
          ...
          return (
            <button
              ...
              className={`
                ...
                ${isSelected ? 'ring-2 ring-[#9F1239] bg-[#9F1239]/5 border-[#9F1239]/30' : 'border-[#E7E5E4] hover:bg-[#F5F5F4]'}
              `}
            >
              <div className="flex items-start gap-4">
                <div className={`
                  w-12 h-12 rounded-lg flex items-center justify-center flex-shrink-0
                  ${isSelected ? 'bg-[#9F1239]' : 'bg-[#F5F5F4]'}
                `}>
                ...
                <div className="flex-1">
                  <h3 className="text-lg font-semibold text-[#1C1917] mb-1">{label.name}</h3>
                  <p className="text-sm text-[#57534E]">{label.description}</p>
                </div>
                {isSelected && (
      ...
      <div className="flex justify-between pt-4">
        ...
        <button
          ...
          className="bg-[#9F1239] hover:bg-[#881337] px-8 py-3 text-white font-bold rounded-xl flex items-center gap-2 ml-auto disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
          Continue
  ...
  const renderStep2 = () => (
    ...
    >
      <div>
        <h2 className="text-2xl font-bold text-[#1C1917] mb-2">Tell us about your restaurant</h2>
        <p className="text-[#57534E] text-sm">Size and location help us recommend the right features</p>
      </div>

      {/* Restaurant Size */}
      <div>
        <label className="block text-sm font-semibold text-[#1C1917] mb-3">Restaurant Size</label>
          ...
          {(Object.keys(SIZE_LABELS) as RestaurantSize[]).map((size) => {
            ...
            return (
              ...
              >
                ...
                <div className="font-semibold text-[#1C1917]">{label.name}</div>
                <div className="text-xs text-[#A8A29E] mt-1">{label.range}</div>
              </button>
            );
          })}
        </div>
      ...
      <div>
        <label htmlFor="seat_count" className="block text-sm font-semibold text-[#1C1917] mb-2">
          Total Number of Seats <span className="text-[#9F1239]">*</span>
        </label>
        <input
          id="seat_count"
          type="number"
          ...
          placeholder="e.g., 45"
          className="w-full px-4 py-3 bg-[#F5F5F4] border border-[#E7E5E4] rounded-xl text-[#1C1917] placeholder-[#A8A29E] focus:outline-none focus:ring-2 focus:ring-[#9F1239]/20 focus:border-[#9F1239] transition-all"
          min="1"
          max="500"
        />
      ...
      {/* Location Type */}
      <div>
        <label className="block text-sm font-semibold text-[#1C1917] mb-3">Location Type</label>
            ...
            return (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="font-semibold text-[#1C1917] text-sm">{label.name}</div>
                    <div className="text-xs text-[#A8A29E] mt-1">{label.description}</div>
                  </div>
                  {isSelected && (
                    <div className="text-[#9F1239]">
      ...
      <div className="flex justify-between pt-4">
        ...
        <button
          ...
          className="bg-[#9F1239] hover:bg-[#881337] px-8 py-3 text-white font-bold rounded-xl flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
        >
          Continue
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
  ...
  const renderStep3 = () => {
    ...
    return (
      ...
      >
        <div>
          <h2 className="text-2xl font-bold text-[#1C1917] mb-2">What are your main priorities?</h2>
            ...
            return (
              ...
              >
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-[#1C1917] mb-1">{label.name}</h3>
                    <p className="text-xs text-[#A8A29E]">{label.description}</p>
                  </div>
                  {isSelected && (
                    <div className="text-[#9F1239]">
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="text-sm text-[#A8A29E] text-center">
  ...
  const renderStep4 = () => (
    ...
    >
      <div>
        <h2 className="text-2xl font-bold text-[#1C1917] mb-2">Choose your dashboard style</h2>
        <p className="text-[#57534E] text-sm">
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <h3 className="text-xl font-semibold text-[#1C1917]">{config.name}</h3>
                    {isRecommended && (
                  ...
                  <p className="text-sm text-[#57534E] mb-3">{config.description}</p>
      ...
      <div className="bg-[#9F1239]/10 border border-[#9F1239]/20 rounded-xl p-4">
        <div className="flex items-start gap-3">
          <div className="text-[#9F1239] flex-shrink-0">
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
  ...
  return (
    <form onSubmit={handleSubmit(handleFormSubmit)} className="w-full">
      ...
      <div className="mb-6">
        ...
        <div className="h-2 bg-[#F5F5F4] rounded-full overflow-hidden border border-[#E7E5E4]">
          <motion.div
