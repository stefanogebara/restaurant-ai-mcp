      ...
      <div>
        ...
        <div className="space-y-2 max-h-64 overflow-y-auto pr-2">
          {data.business_hours.map((day, index) => (
            <div key={day.day}>
              <div className="flex flex-wrap items-center gap-3 p-3 bg-white/40 backdrop-blur-glass-chip rounded-xl border border-glass-border-dark">
        ...
        {selectedServiceType === 'lunch_dinner' && (
          <div className="mt-3 p-3 bg-white/40 backdrop-blur-glass-chip rounded-xl border border-glass-border-dark">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <span className="px-2 py-1 text-xs bg-white/50 backdrop-blur-glass-chip text-muted-stone border border-glass-border-dark rounded-xl">
