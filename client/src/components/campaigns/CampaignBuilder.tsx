    ...
    >
      ...
      <div>
        ...
        <input
          ...
          className="w-full border border-glass-border-input rounded-lg px-3 py-2 text-sm text-deep-charcoal placeholder:text-stone-gray focus:outline-none focus:ring-1 focus:ring-burgundy focus:border-burgundy"
          required
        />
      </div>
      ...
      <div>
        ...
        <select
          ...
          className="w-full border border-glass-border-input rounded-lg px-3 py-2 text-sm text-deep-charcoal bg-white/60 focus:outline-none focus:ring-1 focus:ring-burgundy focus:border-burgundy"
        >
          {TEMPLATES.map((tpl) => (
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full border border-glass-border-input rounded-lg px-3 py-2 text-sm text-deep-charcoal placeholder:text-stone-gray resize-none focus:outline-none focus:ring-1 focus:ring-burgundy focus:border-burgundy"
        />
        ...
        {isScheduled && (
          <div>
            ...
            <input
              ...
              className="border border-glass-border-input rounded-lg px-3 py-2 text-sm text-deep-charcoal focus:outline-none focus:ring-1 focus:ring-burgundy focus:border-burgundy"
