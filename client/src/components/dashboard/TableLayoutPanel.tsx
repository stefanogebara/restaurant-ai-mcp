  ...
  return (
    <>
      ...
      {selectedTable && (
        ...
        >
          <div role="dialog" aria-modal="true" aria-label="Table Actions" className="bg-white rounded-t-2xl sm:rounded-2xl shadow-2xl border border-border-gray max-w-md w-full p-5 max-h-[90vh] overflow-y-auto">
            {/* Header */}
