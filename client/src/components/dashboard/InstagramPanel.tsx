...
export default function InstagramPanel() {
  ...
  return (
    <section className="bg-white border border-border-gray rounded-2xl p-6 space-y-5" data-testid="instagram-panel">
      ...
      {connected && data?.username && (
        <div className="flex items-center gap-3 p-3 bg-warm-white border border-border-gray rounded-xl">
