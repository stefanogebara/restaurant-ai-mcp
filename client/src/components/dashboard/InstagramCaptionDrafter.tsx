...
export default function InstagramCaptionDrafter({ toneProfileReady }: InstagramCaptionDrafterProps) {
  ...
  if (!toneProfileReady) {
    return (
      <div
        className="border border-border-gray rounded-xl p-4 bg-warm-white"
  ...
  return (
    <div className="border border-border-gray rounded-xl p-4 space-y-4 bg-warm-white" data-testid="instagram-caption-drafter">
      <div>
        <p className="text-sm font-medium text-deep-charcoal">Caption drafter</p>
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          maxLength={300}
          className="w-full px-3 py-2 border border-border-gray rounded-lg text-sm focus:outline-none focus:border-burgundy"
      ...
      {drafts.length > 0 && (
        <div className="space-y-3 pt-2 border-t border-border-gray" data-testid="instagram-caption-drafter-results">
          {drafts.map((d, i) => (
            <div key={i} className="bg-white border border-border-gray rounded-lg p-3 space-y-2">
