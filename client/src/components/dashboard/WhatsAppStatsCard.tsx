...
export default function WhatsAppStatsCard() {
  ...
  // Auto-hide when WhatsApp is not enabled
    ...
    <div className="bg-white border border-[#E7E5E4] rounded-2xl p-5 shadow-sm">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-[#1C1917]">WhatsApp</h3>
        </div>
      ...
      {statsLoading ? (
        <div className="animate-pulse flex gap-4">
          <div className="h-12 flex-1 bg-[#F5F5F4] rounded-lg" />
          <div className="h-12 flex-1 bg-[#F5F5F4] rounded-lg" />
        </div>
      ) : (
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-[#F5F5F4] rounded-xl px-3 py-2.5 text-center">
            <p className="text-lg font-bold text-[#1C1917]">{stats?.active_sessions ?? 0}</p>
            <p className="text-[10px] text-[#78716C]">Active Chats</p>
          </div>
          <div className="bg-[#F5F5F4] rounded-xl px-3 py-2.5 text-center">
            <p className="text-lg font-bold text-[#1C1917]">{stats?.messages_this_month ?? 0}</p>
            <p className="text-[10px] text-[#78716C]">Messages/Mo</p>
          </div>
        </div>
      )}
    </div>
