      ...
      return (
        <div className="min-h-[50vh] flex flex-col items-center justify-center p-6">
          <div className="bg-white border border-[#E7E5E4] rounded-2xl p-8 max-w-md text-center shadow-sm">
            ...
            <h3 className="text-lg font-bold text-[#1C1917] mb-2">Something went wrong</h3>
            <p className="text-sm text-[#57534E] mb-4">
              An unexpected error occurred. Please refresh the page.
            </p>
            <button
              onClick={() => window.location.reload()}
              className="px-6 py-2.5 bg-[#9F1239] hover:bg-[#881337] text-white font-semibold rounded-xl transition-colors text-sm"
            >
              Refresh Page
            </button>
          </div>
