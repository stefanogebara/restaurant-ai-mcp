...
export function Skeleton({ className = '' }: SkeletonProps) {
  return (
    <div
      className={`animate-pulse bg-[#E7E5E4] rounded ${className}`}
      aria-hidden="true"
    />
  );
}
...
export function SkeletonStatCard() {
  return (
    <div className="bg-white rounded-xl p-4 border border-[#E7E5E4]/50 shadow-sm" aria-hidden="true">
...
export function SkeletonReservationRow() {
  return (
    <div className="p-4 border-b border-[#E7E5E4]/50" aria-hidden="true">
...
export function SkeletonActiveParty() {
  return (
    <div className="p-3 bg-[#F5F5F4]/30 rounded-lg" aria-hidden="true">
...
export function DashboardSkeleton() {
  return (
    <div className="space-y-6" aria-label="Loading dashboard..." role="status">
      ...
      {/* Table Grid */}
      <div className="bg-white rounded-xl p-6 border border-[#E7E5E4]/50 shadow-sm">
...
export function SkeletonAnalytics() {
  return (
    <div className="min-h-screen bg-[#FAFAF9]" aria-label="Loading analytics..." role="status">
      {/* Header */}
      <div className="bg-white border-b border-[#E7E5E4]/50 px-6 py-5">
      ...
      <div className="max-w-[1600px] mx-auto px-6 pb-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="lg:col-span-2 bg-white rounded-xl border border-[#E7E5E4]/50 shadow-sm p-6">
...
export function SkeletonTableConfig() {
  return (
    <div className="min-h-screen bg-[#FAFAF9]" aria-label="Loading tables..." role="status">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {Array.from({ length: 8 }).map((_, i) => (
            <div key={i} className="bg-white rounded-xl border border-[#E7E5E4]/50 shadow-sm p-5 space-y-3">
              <div className="flex items-center justify-between">
  ...
  return (
    <div className="space-y-6 p-6" aria-label="Loading call data..." role="status">
      ...
      <div className="bg-white rounded-xl border border-[#E7E5E4]/50 shadow-sm overflow-hidden">
        <div className="p-4 border-b border-[#E7E5E4]/50 flex items-center justify-between">
        ...
        {Array.from({ length: 5 }).map((_, i) => (
          <div key={i} className="p-4 border-b border-[#E7E5E4]/50 flex items-center gap-4">
            <Skeleton className="w-9 h-9 rounded-full" />
            <div className="flex-1 space-y-2">
  ...
  return (
    <div className="min-h-screen bg-[#FAFAF9]" aria-label="Loading subscription..." role="status">
      <div className="max-w-4xl mx-auto px-6 py-12 space-y-8">
        ...
        {/* Plan card */}
        <div className="bg-white rounded-2xl border border-[#E7E5E4]/50 shadow-sm p-8 space-y-6">
          <div className="flex items-center justify-between">
            <div className="space-y-2">
          ...
          <div className="border-t border-[#E7E5E4]/50 pt-6">
        ...
        {/* Usage section */}
        <div className="bg-white rounded-2xl border border-[#E7E5E4]/50 shadow-sm p-8 space-y-4">
