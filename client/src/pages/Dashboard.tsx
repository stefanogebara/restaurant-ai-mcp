    ...
    <DashboardLayout>
      <div className="dashboard min-h-screen bg-soft-gray p-6 sm:p-8 md:p-10 pb-28 sm:pb-10">
        ...
        <button
          ...
          className="fixed bottom-24 sm:bottom-6 right-4 sm:right-6 z-50 w-14 h-14 bg-deep-charcoal hover:bg-charcoal-dark hover:scale-105 active:scale-95 text-white rounded-full shadow-xl shadow-black/20 transition-all duration-200 flex items-center justify-center"
        >
