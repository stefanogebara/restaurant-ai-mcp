...
// ---------- 4. Makoto — Japanese Fine Dining, Madrid ----------

const makotoPreset: DemoPreset = {
  name: 'Makoto',
  cuisine: 'Japanese Fine Dining',
  neighborhood: 'Barrio Salamanca, Madrid',
  tables: [
    { id: 'mk1', table_number: '1', capacity: 2, status: 'Occupied',  location: 'Barra de Sushi' },
    { id: 'mk2', table_number: '2', capacity: 2, status: 'Available', location: 'Barra de Sushi' },
    { id: 'mk3', table_number: '3', capacity: 4, status: 'Reserved',  location: 'Sala Principal' },
    { id: 'mk4', table_number: '4', capacity: 4, status: 'Occupied',  location: 'Sala Principal' },
    { id: 'mk5', table_number: '5', capacity: 4, status: 'Available', location: 'Sala Principal' },
    { id: 'mk6', table_number: '6', capacity: 6, status: 'Available', location: 'Sala Principal' },
    { id: 'mk7', table_number: '7', capacity: 4, status: 'Reserved',  location: 'Terraza' },
    { id: 'mk8', table_number: '8', capacity: 6, status: 'Available', location: 'Terraza' },
    { id: 'mk9', table_number: '9', capacity: 8, status: 'Available', location: 'Sala Privada' },
  ],
  reservations: [
    {
      reservation_id: 'mk-r1',
      customer_name: 'Elena García Ruiz',
      customer_phone: '+34 917 314 342',
      party_size: 2,
      date: today,
      time: '14:00',
      reservation_time: `${today}T14:00:00`,
      special_requests: 'Menú omakase — alérgica al marisco',
      checked_in: false,
      status: 'confirmed',
    },
    {
      reservation_id: 'mk-r2',
      customer_name: 'Javier Martínez Blanco',
      customer_phone: '+34 600 123 456',
      party_size: 4,
      date: today,
      time: '15:00',
      reservation_time: `${today}T15:00:00`,
      special_requests: 'Comida de negocios — mesa discreta',
      checked_in: false,
      status: 'confirmed',
    },
    {
      reservation_id: 'mk-r3',
      customer_name: 'Sofía Fernández López',
      customer_phone: '+34 650 987 321',
      party_size: 2,
      date: today,
      time: '21:30',
      reservation_time: `${today}T21:30:00`,
      special_requests: 'Aniversario — maridaje de sake',
      checked_in: false,
      status: 'confirmed',
    },
    {
      reservation_id: 'mk-r4',
      customer_name: 'Andrés Torres Sánchez',
      customer_phone: '+34 630 456 789',
      party_size: 6,
      date: today,
      time: '22:00',
      reservation_time: `${today}T22:00:00`,
      special_requests: 'Sala privada — wagyu para todos',
      checked_in: false,
      status: 'confirmed',
    },
    {
      reservation_id: 'mk-r5',
      customer_name: 'Lucía Romero Vega',
      customer_phone: '+34 615 234 567',
      party_size: 2,
      date: tomorrow,
      time: '21:00',
      reservation_time: `${tomorrow}T21:00:00`,
      special_requests: 'Contra de sushi bar — experiencia omakase',
      checked_in: false,
      status: 'confirmed',
    },
    {
      reservation_id: 'mk-r6',
      customer_name: 'Miguel Ángel Herrero',
      customer_phone: '+34 665 890 123',
      party_size: 4,
      date: tomorrow,
      time: '22:30',
      reservation_time: `${tomorrow}T22:30:00`,
      special_requests: 'Cumpleaños — tarjeta para el chef',
      checked_in: false,
      status: 'confirmed',
    },
  ],
  activeParties: [
    {
      service_id: 'mk-srv1',
      customer_name: 'Ricardo Vargas',
      customer_phone: '+34 607 345 678',
      party_size: 2,
      tables: ['1'],
      seated_at: eveningTime(21, 15),
      estimated_departure: departureAt(40),
      time_elapsed_minutes: 50,
      time_remaining_minutes: 40,
      is_overdue: false,
    },
    {
      service_id: 'mk-srv2',
      customer_name: 'Isabel Moreno Castro',
      customer_phone: '+34 680 123 456',
      party_size: 4,
      tables: ['4'],
      seated_at: eveningTime(21, 30),
      estimated_departure: departureAt(65),
      time_elapsed_minutes: 30,
      time_remaining_minutes: 65,
      is_overdue: false,
    },
  ],
  waitlist: [
    {
      id: 'mk-w1',
      customer_name: 'Carlos Domingo Ríos',
      customer_phone: '+34 643 567 890',
      party_size: 2,
      estimated_wait: 30,
      added_at: eveningTime(22, 5),
      status: 'Waiting',
      special_requests: 'Barra de sushi si es posible',
    },
    {
      id: 'mk-w2',
      customer_name: 'Valentina Cruz Pinto',
      customer_phone: '+34 612 890 123',
      party_size: 4,
      estimated_wait: 45,
      added_at: eveningTime(22, 12),
      status: 'Waiting',
    },
  ],
  info: {
