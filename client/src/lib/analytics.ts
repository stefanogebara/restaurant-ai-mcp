...
export function trackDemoFunnel(props: { step: 'demo_started' | 'demo_interacted' | 'demo_share_clicked' | 'signup_started' | 'match_confirmed' | 'match_rejected' | 'new_restaurant_path' | 'demo_chat_opened' | 'demo_chat_booking_confirmed' | 'demo_dashboard_revealed'; preset?: string }): void {
