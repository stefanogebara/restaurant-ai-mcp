...
const FATOS_SYSTEM = [
  ...
  `  "modelo_conta": string,        // SÓ se o lead descreveu como a casa cobra o consumo:`,
  `                                 // "comanda_individual" (cada pessoa tem a própria comanda`,
  `                                 // e paga a sua no caixa) | "conta_mesa" (conta única da`,
  `                                 // mesa, o grupo divide) | "ambos". Nunca chute.`,
  `  "dor_pagamento": string[],     // dores DITAS sobre a hora de pagar ("fila no caixa",`,
  `                                 // "garçom preso com a maquininha", "cliente erra a divisão")`,
  `  "sistemas": string[],          // sistemas/apps que o lead DISSE usar ("Goomer", "Menew",`,
  `                                 // "Tagme", "iFood", "caderno/planilha")`,
  `  "usa_vr": boolean,             // true/false só se o lead disse se aceita vale-refeição`,
  `  "aceita_reserva": boolean      // true/false só se o lead disse se trabalha com reserva`,
  `}`,
  ``,
