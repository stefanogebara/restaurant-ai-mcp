...
/**
 * Despachante de crons — teto de 120s.
 *
 ...
 * rodada pagaria o custo de inicializar 3 módulos para usar um.
 *
...
const JOBS = {
  'prospect-dispatch': (req, res) => require('../_crons/prospect-dispatch')(req, res),
  'prospect-flush': (req, res) => require('../_crons/prospect-flush')(req, res),
  'prospect-nudge': (req, res) => require('../_crons/prospect-nudge')(req, res),
};
